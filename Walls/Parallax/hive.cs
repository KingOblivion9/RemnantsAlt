...
namespace Remnants.Walls.Parallax
{
    public class hive : ModWall
    {
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            //Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/Walls/Backgrounds/hiveglow").Value, new Vector2((i * 16) - (int)Main.screenPosition.X, (j * 16) - (int)Main.screenPosition.Y) + zero, frame, Color.White, 0f, Vector2.Zero, 1f, 0, 0f);
            ...
            //	Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/Walls/Backgrounds/hiveglow").Value, new Vector2((i * 16) - (int)Main.screenPosition.X + x, (j * 16) - (int)Main.screenPosition.Y + y) + zero, frame, color, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
            //}
            return false;
        }
