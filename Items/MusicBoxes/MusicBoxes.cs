...
public class EchoingMusicBox : ModItem
{
    public override void SetStaticDefaults()
    {
        ...
        MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/WARD"), ModContent.ItemType<EchoingMusicBox>(), ModContent.TileType<EchoingMusicBoxTile>());
    }
...
public class MagicalMusicBox : ModItem
{
    ...
    {
        Item.ResearchUnlockCount = 1;
        MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/MageLab"), ModContent.ItemType<MagicalMusicBox>(), ModContent.TileType<MagicalMusicBoxTile>());
    }
...
public class ForgottenMusicBox : ModItem
{
    ...
    {
        Item.ResearchUnlockCount = 1;
        MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/Tomb"), ModContent.ItemType<ForgottenMusicBox>(), ModContent.TileType<ForgottenMusicBoxTile>());
    }
...
public class CloudyMusicBox : ModItem
{
    ...
    {
        Item.ResearchUnlockCount = 1;
        MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/Garden"), ModContent.ItemType<CloudyMusicBox>(), ModContent.TileType<CloudyMusicBoxTile>());
    }
...
public class GraniteMusicBox : ModItem
{
    ...
    {
        Item.ResearchUnlockCount = 1;
        MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/Granite"), ModContent.ItemType<GraniteMusicBox>(), ModContent.TileType<GraniteMusicBoxTile>());
    }
...
public class MarbleMusicBox : ModItem
{
    ...
    {
        Item.ResearchUnlockCount = 1;
        MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/Marble"), ModContent.ItemType<MarbleMusicBox>(), ModContent.TileType<MarbleMusicBoxTile>());
    }
